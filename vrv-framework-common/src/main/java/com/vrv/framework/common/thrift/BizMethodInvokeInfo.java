...
public class BizMethodInvokeInfo implements org.apache.thrift.TBase<BizMethodInvokeInfo, BizMethodInvokeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<BizMethodInvokeInfo> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new BizMethodInvokeInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new BizMethodInvokeInfoTupleSchemeFactory();
  ...
  public void unsetSuccessAverageTime() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SUCCESSAVERAGETIME_ISSET_ID);
  }
  ...
  public boolean isSetSuccessAverageTime() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SUCCESSAVERAGETIME_ISSET_ID);
  }

  public void setSuccessAverageTimeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SUCCESSAVERAGETIME_ISSET_ID, value);
  }
  ...
  public void unsetSuccessMinTime() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SUCCESSMINTIME_ISSET_ID);
  }
  ...
  public boolean isSetSuccessMinTime() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SUCCESSMINTIME_ISSET_ID);
  }

  public void setSuccessMinTimeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SUCCESSMINTIME_ISSET_ID, value);
  }
  ...
  public void unsetSuccessMaxTime() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SUCCESSMAXTIME_ISSET_ID);
  }
  ...
  public boolean isSetSuccessMaxTime() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SUCCESSMAXTIME_ISSET_ID);
  }

  public void setSuccessMaxTimeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SUCCESSMAXTIME_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(successAverageTime);

    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(successMinTime);

    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(successMaxTime);
  ...
  public int compareTo(BizMethodInvokeInfo other) {
    ...
    lastComparison = Boolean.compare(isSetSuccessCount(), other.isSetSuccessCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.compare(isSetFailureCount(), other.isSetFailureCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.compare(isSetSuccessAverageTime(), other.isSetSuccessAverageTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.compare(isSetSuccessMinTime(), other.isSetSuccessMinTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.compare(isSetSuccessMaxTime(), other.isSetSuccessMaxTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class BizMethodInvokeInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public BizMethodInvokeInfoStandardScheme getScheme() {
      return new BizMethodInvokeInfoStandardScheme();
    }
  }

  private static class BizMethodInvokeInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<BizMethodInvokeInfo> {
  ...
  private static class BizMethodInvokeInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public BizMethodInvokeInfoTupleScheme getScheme() {
      return new BizMethodInvokeInfoTupleScheme();
    }
  }

  private static class BizMethodInvokeInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<BizMethodInvokeInfo> {
