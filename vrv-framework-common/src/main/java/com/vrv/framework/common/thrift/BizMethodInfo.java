...
public class BizMethodInfo implements org.apache.thrift.TBase<BizMethodInfo, BizMethodInfo._Fields>, java.io.Serializable, Cloneable, Comparable<BizMethodInfo> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new BizMethodInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new BizMethodInfoTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable String name; // required
  public byte argsNum; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<String> argsType; // required
  ...
  public BizMethodInfo(
    String name,
    byte argsNum,
    java.util.List<String> argsType)
  {
    this();
    this.name = name;
  ...
  public BizMethodInfo(BizMethodInfo other) {
    ...
    if (other.isSetArgsType()) {
      java.util.List<String> __this__argsType = new java.util.ArrayList<String>(other.argsType);
  ...
  public BizMethodInfo setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public void unsetArgsNum() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ARGSNUM_ISSET_ID);
  }

  /** Returns true if field argsNum is set (has been assigned a value) and false otherwise */
  public boolean isSetArgsNum() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ARGSNUM_ISSET_ID);
  }

  public void setArgsNumIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ARGSNUM_ISSET_ID, value);
  }
  ...
  public void addToArgsType(String elem) {
    if (this.argsType == null) {
      this.argsType = new java.util.ArrayList<String>();
    }
    this.argsType.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<String> getArgsType() {
    return this.argsType;
  }

  public BizMethodInfo setArgsType(@org.apache.thrift.annotation.Nullable java.util.List<String> argsType) {
    this.argsType = argsType;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case ARGS_TYPE:
      if (value == null) {
        ...
        setArgsType((java.util.List<String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + (int) (argsNum);

    hashCode = hashCode * 8191 + ((isSetArgsType()) ? 131071 : 524287);
    if (isSetArgsType())
      hashCode = hashCode * 8191 + argsType.hashCode();
  ...
  public int compareTo(BizMethodInfo other) {
    ...
    lastComparison = Boolean.compare(isSetArgsNum(), other.isSetArgsNum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArgsNum()) {
    ...
    lastComparison = Boolean.compare(isSetArgsType(), other.isSetArgsType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArgsType()) {
  ...
  private static class BizMethodInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public BizMethodInfoStandardScheme getScheme() {
      return new BizMethodInfoStandardScheme();
    }
  }

  private static class BizMethodInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<BizMethodInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.argsType = new java.util.ArrayList<String>(_list0.size);
                @org.apache.thrift.annotation.Nullable String _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readString();
                  struct.argsType.add(_elem1);
                }
                iprot.readListEnd();
              }
  ...
  private static class BizMethodInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public BizMethodInfoTupleScheme getScheme() {
      return new BizMethodInfoTupleScheme();
    }
  }

  private static class BizMethodInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<BizMethodInfo> {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.argsType = new java.util.ArrayList<String>(_list5.size);
          @org.apache.thrift.annotation.Nullable String _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readString();
            struct.argsType.add(_elem6);
          }
        }
        struct.setArgsTypeIsSet(true);
      }
